...
// APIKeyScope identifies the ownership and runtime behavior of an API key.
...
type CreateAPIKeyParams struct {
	...
	AccountID    string      `json:"account_id,omitempty"`
	WorkspaceIDs []string    `json:"workspace_ids,omitempty"`
	CreatedBy    string      `json:"created_by,omitempty"` // Defaults to the acting workspace user when available.
...
type ListAPIKeysParams struct {
	...
	IncludeAllUsers bool        `json:"include_all_users,omitempty"`
