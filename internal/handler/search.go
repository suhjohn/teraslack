...
// SearchMessages handles GET /api/search.messages?team_id=T123&query=hello&limit=20
...
// SearchFiles handles GET /api/search.files?team_id=T123&query=hello&limit=20
